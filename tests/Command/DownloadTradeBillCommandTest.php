...
use WechatPayBundle\Command\DownloadTradeBillCommand;

/**
 * @internal
 */
#[CoversClass(DownloadTradeBillCommand::class)]
#[RunTestsInSeparateProcesses]
final class DownloadTradeBillCommandTest extends AbstractCommandTestCase
{
    ...
    {
        $command = self::getContainer()->get(DownloadTradeBillCommand::class);
